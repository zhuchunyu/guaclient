...
public abstract class TunnelRequest {
    ...
    /**
     * Returns the integer value of the parameter having the given name, throwing an exception if
    ...
    /**
     * Returns the identifier of the AuthenticationProvider associated with the UserContext from
     * which the connection or connection group is to be retrieved when the tunnel is created. In
     * the context of the REST API and the JavaScript side of the web application, this is referred
     * to as the data source identifier.
     *
     * @return The identifier of the AuthenticationProvider associated with the UserContext from
     * which the connection or connection group is to be retrieved when the tunnel is created.
     ...
     * @throws GuacamoleException If the type was not present in the request, or if the type
     *                            requested is in the wrong format.
     */
    ...
    /**
     * Returns the identifier of the destination of the tunnel being requested. As there are
     * multiple types of destination objects available, and within multiple data sources, the
     * associated object type and data source are also necessary to determine what this identifier
     * refers to.
     *
     ...
     *
     * @return The display width desired for the Guacamole session over the tunnel being requested,
    ...
    /**
     * Returns the display height desired for the Guacamole session over the tunnel being
     * requested.
     *
     ...
     *
     * @return A list of all audio mimetypes declared as supported within the tunnel request, or
     * null if no mimetypes were specified.
     */
     ...
     *
     * @return A list of all video mimetypes declared as supported within the tunnel request, or
     * null if no mimetypes were specified.
     */
     ...
     *
     * @return A list of all image mimetypes declared as supported within the tunnel request, or
     * null if no mimetypes were specified.
     */
